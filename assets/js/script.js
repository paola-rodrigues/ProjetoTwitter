...
function criarTweet(tweetTexto){
  ...
  const tweet = {
    nome: "Paola",
    foto: "./assets/img/Imagem2.jpg",
    figura:"./assets/img/aceitar.png",
    usuario: "@paola.n.rodrigues",
    texto:tweetTexto,
    tempo:`${hora}:${minutos}`
  }
...
function listarTemplateTweet(tweet){
    ...
    const {nome,foto,figura, usuario,texto,tempo} = tweet
    ...
    span.classList.add("tweet__conteudo__span")
